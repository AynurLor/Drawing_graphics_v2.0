...
В данном проекте было реализовано приложение для просмотра 3D моделей в каркасном виде на языке программирования С++ в парадигме объектно-ориентированного программирования.

## 1. 3DViewer v2.0

![3dviewer2.0](misc/images/menu_3dview_v2.PNG)
...
## 2. Дополнительно. Настройки

![3dviewer2.0](misc/images/settings_3dview_v2.PNG)
...
## 3. Дополнительно. Запись

![3dviewer2.0](misc/images/porshe.jpeg)
